...
class _PenilaianScreenState extends State<PenilaianScreen> {
  ...
  late final TextEditingController pengumumanController, linkController;
  ...
  final testSlicing = [
    CustomDataCell(const Text("Upin bin Ahmad")),
    CustomDataCell(const Text("08123456789")),
    CustomDataCell(const Text("Tok Dalang")),
    CustomDataCell(
      const Text("1"),
    ),
    CustomDataCell(
  ...
  void initState() {
    ...
    nilai1Controller = CustomDropdownController<String>();
    nilai2Controller = CustomDropdownController<String>();
    nilai3Controller = CustomDropdownController<String>();
    nilai4Controller = CustomDropdownController<String>();
