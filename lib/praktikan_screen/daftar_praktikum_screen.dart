...
import 'package:smartcare_web/praktikan_screen/pilih_jadwal_screen.dart';
...
class DaftarPraktikumScreen extends StatefulWidget {
  const DaftarPraktikumScreen({Key? key}) : super(key: key);

  @override
  _DaftarPraktikumScreenState createState() => _DaftarPraktikumScreenState();
}

class _DaftarPraktikumScreenState extends State<DaftarPraktikumScreen> {
  Choice _selectedChoice = choices[0];
  @override
  Widget build(BuildContext context) {
    final testSlicing = [
      CustomDataCell(const Text("Praktikum A")),
      CustomDataCell(const Text("Belum Diambil")),
